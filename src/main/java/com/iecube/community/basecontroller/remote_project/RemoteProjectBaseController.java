package com.iecube.community.basecontroller.remote_project;
...
public class RemoteProjectBaseController extends BaseController {
    ...
    public JsonResult<Void> handleException(Throwable e){
        ...
        } else if (e instanceof AppointmentFailedException) {
