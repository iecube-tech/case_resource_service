...
public class GradeExcelGenEmdV4 {
    public void genSheetOverview(Workbook workbook,Map<Long, List<PstReportDTO>> pstReportDTOListGroupByPT, Map<String, List<PstReportDTO>> pstReportDTOGroupByStudentId){
    ...
    public void genTaskView(Workbook workbook, String sheetName, List<PstReportDTO> pstReportDTOList, Map<Long,List<PstReportCommentDto>> pstComponentsMap ){
        ...
        components.forEach(component->{
            ...
            sheet.addMergedRegion(new CellRangeAddress(0,0, taskStartIndex.get(), taskStartIndex.get() +1)); // 合并
            headerRow1.createCell(taskStartIndex.get()).setCellValue(component.getName());
